...
const countNumberOfParam= () => {
    ...
    if(strengthScore[strengthScore.length-1] <= 1){
        document.querySelector('.strengthLevel').innerHTML= "Very Weak";
        ...
        elements[0].style.backgroundColor = '#21453E';
        elements[0].style.borderColor = '#21453E';
        elements[1].style.backgroundColor = '#21453E';
        elements[1].style.borderColor = '#21453E';
        elements[2].style.backgroundColor = '#21453E';
        elements[2].style.borderColor = '#21453E';
        elements[3].style.backgroundColor = '#21453E';
        elements[3].style.borderColor = '#21453E';
     }
